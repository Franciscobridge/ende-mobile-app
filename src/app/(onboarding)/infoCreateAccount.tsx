...
export default function InfoCreateAccount() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 bg-background px-3">
        {/* Cabeçalho */}
        <View className="items-start mb-12">
          <Image
            ...
            resizeMode="contain"
          />
          <Text className="text-foreground font-bold text-lg -mt-6">Empresa Nacional Distribuidora de Energia</Text>
        </View>

        {/* Introdução */}
        <Text className="text-white font-sans mb-8">
        ...
        <View className="flex-row items-start gap-4 bg-muted p-4 rounded-lg mb-4">
          ...
          <View className="flex-1">
            <Text className="text-white font-bold mb-1">1. Documentos necessários</Text>
            <Text className="text-foreground/80 text-xs leading-relaxed">
        ...
        <View className="flex-row items-start gap-4 bg-muted p-4 rounded-lg mb-4">
          ...
          <View className="flex-1">
            <Text className="text-white font-bold mb-1">2. Dirija-se ao posto da ENDE</Text>
            <Text className="text-foreground/80 text-xs leading-relaxed">
        ...
        <View className="flex-row items-start gap-4 bg-muted p-4 rounded-lg mb-4">
          ...
          <View className="flex-1">
            <Text className="text-white font-bold mb-1">3. Preenchimento do formulário</Text>
            <Text className="text-foreground/80 text-xs leading-relaxed">
        ...
        <View className="flex-row items-start gap-4 bg-muted p-4 rounded-lg">
          ...
          <View className="flex-1">
            <Text className="text-white font-bold mb-1">4. Pagamento da taxa</Text>
            <Text className="text-foreground/80 text-xs leading-relaxed">
