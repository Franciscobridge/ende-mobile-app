...
export function RecentAdd({ data, saldo, valor }: RecentAddProps) {
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.5}
      className="bg-light-background dark:bg-card/20 w-full flex-row h-16 gap-2 px-3 rounded-lg items-center"
    >
      ...
      <View>
        ...
        <View className="w-full flex-row gap-3 items-center">
          <Text className="text-xs text-light-foreground font-bold dark:text-foreground/80">
            Saldo: <Text className="text-primary dark:text-green-400">{`${saldo} kw`}</Text>
          </Text>
          <Text className="text-xs text-light-foreground/80 dark:text-foreground/50">|</Text>
          <Text className="text-xs text-light-foreground font-bold dark:text-foreground/80">
            Valor: <Text className="text-primary dark:text-green-400">{`${valor} kz`}</Text>
          </Text>
        </View>
      </View>
    </TouchableOpacity>
